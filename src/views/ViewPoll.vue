...
<template>
  <section
    ...
    class="flex flex-wrap my-6 justify-evenly select-none"
  >
    <div class="vote pt-10">
      ...
      <div @click="total.firstTotalVotes">
        ...
        >
          ...
          <p class="pt-2 text-xs text-gray-400 pl-4">
            {{ total.firstVote }} votes
          </p>
        </div>
      </div>
    ...
    <div class="my-12">
      ...
      <div class="shadow-md mt-6 p-6 h-40">
        ...
        <div class="pt-2 flex gap-2 cursor-pointer">
          ...
          <p class="text-red-600 text-sm font-semibold tracking-wider">
            Copy Link
          </p>
        </div>
      </div>
      <button
        class="border-2 border-gray-300 p-2 mt-4 float-right text-gray-400 cursor-pointer"
      >
        Report Abuse
      </button>
    </div>
